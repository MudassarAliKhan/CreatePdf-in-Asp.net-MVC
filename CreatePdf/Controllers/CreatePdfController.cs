...
namespace CreatePdf.Controllers
{
    public class CreatePdfController : Controller
    {
        ...
        public ActionResult Index_Post()
        {
            ...
            //Cell no 2
            chunk = new Chunk("My Name is Mudassar Ali Khan From Abbottabad Pakistan ", FontFactory.GetFont("Arial", 15, Font.NORMAL, BaseColor.PINK));
            cell = new PdfPCell();
            cell.Border = 0;
            ...
            para.Add("Thank you for being our valuable customer. We hope our letter finds you in the best of health and wealth.\n\nYours Sincerely, \nBank of America");
            pdfDoc.Add(para);
            ...
            para = new Paragraph();
            para.Add("This PDF is generated using iTextSharp.");
            para.SpacingBefore = 20f;
            para.SpacingAfter = 20f;
            pdfDoc.Add(para);

            //Creating link
            chunk = new Chunk("Pakistan");
            chunk.Font = FontFactory.GetFont("Arial", 25, Font.BOLD, BaseColor.RED);
            chunk.SetAnchor("http://paksoftvalley.business.site");
            pdfDoc.Add(chunk);
